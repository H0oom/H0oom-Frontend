      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white border border-gray-100 shadow-xl">
          <CardHeader className="text-center pb-2">
            <CardTitle className="text-black text-2xl font-light">
              Welcome
            </CardTitle>
              ...
              <TabsContent value="login" className="space-y-6 mt-8">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`bg-white border-gray-200 text-black placeholder-gray-400 h-12 rounded-xl focus:border-black focus:ring-1 focus:ring-black ${
